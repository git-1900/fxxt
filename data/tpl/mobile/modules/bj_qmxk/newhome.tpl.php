...
<body class="body-gray">
    ...
    <div class="panel memberhead">
        <div class="header-l"><img class="icon-level-p1" src="<?php  if(empty($myheadimg['avatar'])) { ?><?php echo BJ_QMXK_ROOT;?>/style/images/yh.png<?php  } else { ?><?php  echo $myheadimg['avatar'];?><?php  } ?>"/></div>
    ...
    <!--count end-->
       ...
       <?php  if($profile['flag']==1) { ?>
              ...
              <?php  if($profile['flag']==1&&$commtime['ischeck']==2) { ?>
				 <li><a href="<?php  echo $this->createMobileUrl('dzd',array('op'=>'setting'))?>"><i class="icon-account"></i><span class="text">设置店中店</span><i class="arrow"></i></a></li>
        
           	    <?php  if(false&&$profile['flag']==1&&$profile['dzdflag']==1) { ?>
				 <li><a href="<?php  echo $this->createMobileUrl('list',array('dzdid'=>$profile['id']))?>"><i class="icon-qrcode"></i><span class="text">我的店中店</span><i class="arrow"></i></a></li>
           	<?php  } ?>    	<?php  } ?> 
			<li>
