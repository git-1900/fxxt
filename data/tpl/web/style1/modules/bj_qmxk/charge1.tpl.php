...
<ul class="nav nav-tabs">
 	<li  class="active"><a href="<?php  echo create_url('site/module', array('do' => 'charge1', 'op' => 'list','name' => 'bj_qmxk','weid'=>$_W['weid']))?>">在线充值</a></li>	
    ...
    <div class="main">     
		<div class="stat">
				...
				<input type="hidden" name="do" value="charge1" />
			...
			<div class="stat-div">
				...
				<div class="sub-item" id="table-list">
					<h4 class="sub-title" style="float:right;color:red;">用户总余额：<?php  echo $total;?></h4>
