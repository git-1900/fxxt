...
<ul class="nav nav-tabs">
	...
	<li <?php  if($operation == 'display') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('express',array('op' =>'display'))?>">快递管理</a></li>
        <li<?php  if($operation == 'post' && empty($express['id'])) { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('express',array('op' =>'post'))?>">添加快递公司</a></li>
        <?php  if(!empty($express['id']) && $operation== 'post') { ?> <li class="active"><a href="<?php  echo $this->createWebUrl('express',array('op' =>'post','id'=>$express['id']))?>">编辑快递公司</a></li> <?php  } ?>
		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php  echo $item['express_area'];?></td>
	...
	<input type="hidden" name="id" value="<?php  echo $express['id'];?>" />
		...
		<table class="tb">
			<tr>
				...
				<td>
					<input type="text" name="displayorder" class="span6" value="<?php  echo $express['displayorder'];?>" />
				</td>
			</tr>
                    
                        <tr>
 
                            <th><label for="">常用快递公司</label></th>
				<td>
                              
    
					<select id="common_corp">
...
<option value="zhimakaimen" data-name="芝麻开门">芝麻开门</option>
			...
			<tr>
                            <th><span class='red'>*</span><label for="">物流公司</label></th>
				<td>
					<input type="text" name="express_name" id='express_name' class="span6" value="<?php  echo $express['express_name'];?>" />
				</td>
			</tr>
			<tr class="hide">
				<th><label for="">公司网站</label></th>
				<td>
					<input type="text" id='express_url' name="express_url" class="span6" value="<?php  echo $express['express_url'];?>" />
				</td>
			</tr>	
                        <tr>
				<th><label for="">配送区域</label></th>
				<td>
					<input type="text" id='express_area' name="express_area" class="span6" value="<?php  echo $express['express_area'];?>" />
				</td>
			</tr>	
			<tr>
				<th></th>
