...
<ul class="nav nav-tabs">
	<li class="active"><a href="<?php  echo $this->createWebUrl('commission', array('op'=>'display'))?>">佣金审核提现操作</a></li>
							...
							<tbody>
								<?php  if(is_array($list)) { foreach($list as $v) { ?>
										<tr>
											...
											<td style="text-align: center;">
												<?php  echo date('Y-m-d H:i:s',$v['applytime'])?>
											</td>
												<td style="text-align: center;">
											...
											<td style="text-align: center;">
												<span class="label label-success">正在申请</span>
											</td>
											<td style="text-align: center;">	
