	...
	<form action="" method="post" class="form-horizontal form">
		...
		<table class="tb">
			<tr>
				<th>操作说明</th>
				<td>
					<div class="help-block">运河印象系统使用utf-8无bom格式的文件编码方式, 如果使用编辑器修改配置或者查看文件时没有注意编辑器设置将可能在被编辑的文件上附加BOM头, 从而造成系统功能异常. </div>
					...
					<div class="help-block"><strong>注意: 使用 Windows 系统自带的记事本编辑运河印象源码可能会造成这样的问题. </strong></div>
				</td>
			</tr>
			<tr>
				<th>处理说明</th>
