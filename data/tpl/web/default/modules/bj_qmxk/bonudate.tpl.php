                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="text-align: center;">
                                        <?php  if($v['days']!="") { ?><?php  echo $v['days'];?><?php  } else { ?>暂无设定<?php  } ?>
                                </td>
                                <td style="text-align: center;">
...
<?php  } else if($op=='setdate') { ?>
<!-- 兼容旧版 start -->
<link rel="stylesheet" href="<?php echo BJ_QMXK_ROOT;?>/style/css/amazeui.min.css" />
<!-- 兼容旧版 end -->
<link rel="stylesheet" type="text/css" href="<?php echo BJ_QMXK_ROOT;?>/style/css/layout.css">
<input type="hidden" name="bds" id="bds" value="<?php  echo $bds['days'];?>">
    <div class="f_r xa-content-main" >

        <div class="admin-content">
        	<br />
        	<div class="am-g">
                <div class="am-u-sm-4"><a type="button" href="javascript:history.back(-1)" class="am-btn am-btn-secondary am-btn-sm"><span class="am-icon-reply"> </span>返回</a>&nbsp;&nbsp;&nbsp;<strong><?php  echo $ym;?>&nbsp;&nbsp;&nbsp; 分红日选择</strong></div>
...
<script src="<?php echo BJ_QMXK_ROOT;?>/style/js/amazeui.min.js"></script>
<!--<![endif]-->
<script src="<?php echo BJ_QMXK_ROOT;?>/style/js/app.js"></script>
<!-- 兼容旧版页面 end -->

<script type="text/javascript" src="<?php echo BJ_QMXK_ROOT;?>/style/js/main.common.js"></script>
<script>
      ...
      ;(function(){
			...
			@param obj     当前日期礼拜几
            */
             dateFormSelect.render(<?php  echo $dnums;?>,'.xa-date-li',<?php  echo $w;?>);
      })();
