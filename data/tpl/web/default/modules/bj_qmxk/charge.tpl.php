...
<!--								&nbsp;
										<a href="<?php  echo create_url('site/module', array('do' => 'charge', 'op' => 'post','name' => 'bj_qmxk','weid'=>$_W['weid'],'chargeType'=>'revise','from_user'=>$v['from_user']))?>" class="btn btn-primary">修改</a>	
                                                                        &nbsp;
										<a href="javascript:if(confirm('确实要删除吗?'))location='<?php  echo create_url('site/module', array('do' => 'charge', 'op' => 'post','name' => 'bj_qmxk','weid'=>$_W['weid'],'chargeType'=>'delete','from_user'=>$v['from_user']))?>'" class="btn btn-primary">删除</a>-->
                                                                        </td>
								</tr>
