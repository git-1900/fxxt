...
<ul class="nav nav-tabs">
    <li <?php  if($operation == 'display' && $modules!='promotion') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('adv',array('op' =>'display'))?>">广告</a></li>
    <li<?php  if($operation == 'post' && $modules!='promotion') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('adv',array('op' =>'post'))?>">添加广告</a></li>
