		...
		<table class="table table-hover">
			...
			<?php  if(is_array($category)) { foreach($category as $row) { ?>
				<tr>
					...
					<td><input type="text" name="goodurltest" id="goodurltest" class="span7" value="<?php  echo $_W['siteroot'];?><?php  echo $this->createMobileUrl('list2', array('pcate' => $row['id']))?>"  readonly/></td>
				...
				<tr>
					<td></td>
					<td><input type="text" class="span1" name="displayorder[<?php  echo $row['id'];?>]" value="<?php  echo $row['displayorder'];?>"></td>
					<td><img src="./resource/attachment/<?php  echo $row['thumb'];?>" width='50' height="50" onerror="$(this).remove()" style='padding:1px;border: 1px solid #ccc;float:left;' /><div class="type-child"><?php  echo $row['name'];?>&nbsp;&nbsp; 
						 <?php  if($row['isrecommand']==1) { ?>
                                                <span class='label label-success'>首页推荐</span>
                                                 <?php  } ?>
