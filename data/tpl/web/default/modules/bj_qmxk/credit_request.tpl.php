		...
		<table class="table table-hover">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php  echo $fans[$item['from_user']]['residedist'];?></td>
					...
					<td style="text-align:right;">
						<a href="<?php  echo create_url('site/module/credit', array('name' => 'bj_qmxk', 'id' => $item['id'], 'op' => 'delete'))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;" title="删除" class="btn btn-small"><i class="icon-remove"></i></a>
					</td>
				</tr>
				<?php  } } ?>
			</tbody>
