...
<li><a href="<?php  echo $this->createWebUrl('express',array('op' =>'display'))?>">快递管理</a></li>
    ...
    <li <?php  if($operation == 'display') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dispatch',array('op' =>'display'))?>">配送支付方式</a></li>
    <li<?php  if($operation == 'post') { ?> class="active" <?php  } ?>><a href="<?php  echo $this->createWebUrl('dispatch',array('op' =>'post'))?>">添加配送支付方式</a></li>
    <?php  if(!empty($dispatch['id']) && $operation== 'post') { ?> <li class="active"><a href="<?php  echo $this->createWebUrl('dispatch',array('op' =>'post','id'=>$dispatch['id']))?>">编辑配送支付方式</a></li> <?php  } ?>
        ...
        <table class="table table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    	  <?php  if($item['dispatchtype']==0) { ?>
                    货到付款<?php  } ?><?php  if($item['dispatchtype']==1) { ?>
                    微支付<?php  } ?>
                  
                    <?php  if($item['dispatchtype']==2) { ?>
                    支付宝<?php  } ?>
                      <?php  if($item['dispatchtype']==3) { ?>
                    余额付款<?php  } ?></td>
             ...
             <tr>
                ...
                <td>
                        ...
                        <select name="dispatchtype" id="dispatchtype">
                            ...
                            <option value="0" <?php  if($dispatch['dispatchtype']==0) { ?>selected<?php  } ?>>货到付款</option>
                            	<?php  } ?>
                            		<?php  if(!empty($_W['account']['payment']['wechat']['switch'])) { ?>
                            <option value="1" <?php  if($dispatch['dispatchtype']==1) { ?>selected<?php  } ?>>微支付付款</option>
                            	<?php  } ?>
                            	<?php  if(!empty($_W['account']['payment']['credit']['switch']) ) { ?>
                            <option value="3" <?php  if($dispatch['dispatchtype']==3) { ?>selected<?php  } ?>>余额付款</option>
                               	<?php  } ?>
                        </select> 
