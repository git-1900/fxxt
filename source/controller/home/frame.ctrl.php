							...
							if(is_array($ret)) {
								foreach($ret as $et) {
									$row['items'][] = array($et['title'], $et['url']);
                                            ...
                                            if ($_W['username']!='shanghe_01') {
                                                if($opt['title']=='代理管理' ||$opt['title']=='分红日期' || $opt['title']=='商品管理' || $opt['title']=='广告促销设置'|| $opt['title']=='文章管理'|| $opt['title']=='文章分类'|| $opt['title']=='大转盘管理'|| $opt['title']=='微投票管理'){
                                                    $row['items'][] = array(
                                                            $opt['title'],
