...
if ($operation == 'post') {
    ...
    if (checksubmit('submit')) {
        ...
        if (empty($id)) {
            ...
            unset($data['sales']);
            $aa = pdo_update('bj_qmxk_goods', $data, array('id' => $id));
            print_r($aa);
        }
        $totalstocks = 0;
        ...
        message('商品更新成功！', $this->createWebUrl('goods'), 'success');
    }
