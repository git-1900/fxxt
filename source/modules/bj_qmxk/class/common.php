...
class bj_qmxkModuleCommon extends WeModuleSite
{
    ...
    public function doWebRecoveryData()
    {
        $this->__web(__FUNCTION__);
    }
    ...
    public function doWebCharge()
    {
     ...
     public function doWebCharge1()
    {
        $this->__web(__FUNCTION__);
    }
    public function doWebBonudate()
    {
        $this->__web(__FUNCTION__);
    }
    ...
    public function doMobileCreditDetail()
    {
        $this->__mobile(__FUNCTION__);
    }
    public function doMobileMyRights()
    {
        $this->__mobile(__FUNCTION__);
    }
